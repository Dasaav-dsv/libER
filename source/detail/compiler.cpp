 ...
 * as it had been compiled with the Microsoft Visual Compiler from VS2015, build
 * 26***. MSVC maintains a stable ABI from its 2015 version onwards, any version
 * is okay to use. clang-cl for Visual Studio is exempt from this restriction,
 * as long the MSVC STL is used.
 */
