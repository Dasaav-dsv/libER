...
struct DEFAULT_KEY_ASSIGN {
    ...
    /**
     * @brief Debug menu mode switching
     *
    ...
    /**
     * @brief How to be pushed
     */
    unsigned char traitsType_0{ 0 };

    /**
     * @brief Analog-to-digital conversion method
     */
    unsigned char a2dOperator_0{ 0 };

    /**
     * @brief Applicable target
     *
     * Reflection target
     */
